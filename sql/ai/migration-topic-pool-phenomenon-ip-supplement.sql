-- ============================================================
-- 现象级IP知识主题池 - 全量补充（可手动执行版本）
-- 与 V012__ai_evolve_topic_phenomenon_ip_supplement.sql 内容一致
-- 执行：psql -U postgres -d douyin_operations -f sql/ai/migration-topic-pool-phenomenon-ip-supplement.sql
-- ============================================================
