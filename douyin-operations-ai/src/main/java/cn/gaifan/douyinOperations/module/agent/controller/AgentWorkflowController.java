...
public class AgentWorkflowController {
    ...
    private static final Logger log = LoggerFactory.getLogger(AgentWorkflowController.class);
    ...
    private Integer toInt(Object v, int defaultVal) {
        ...
        try { return Integer.parseInt(v.toString()); } catch (Exception e) {
            log.debug("Integer解析失败: value={}, 使用默认值: {}", v, defaultVal, e);
            return defaultVal;
        }
    }
}
