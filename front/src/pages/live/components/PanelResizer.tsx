...
export const PanelResizer = memo(function PanelResizer({ onResize, onReset }: PanelResizerProps) {
  ...
  return (
    <Box
      ...
      data-testid="live-panel-resizer"
      data-contract-scope="live-panel-resizer-props"
      data-ready-sources="onResize-prop|onReset-prop|localStorage-widths"
      data-no-direct-api-request="true"
      data-reset-enabled={onReset ? 'true' : 'false'}
