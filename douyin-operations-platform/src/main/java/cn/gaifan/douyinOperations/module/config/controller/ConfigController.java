...
import cn.gaifan.douyinOperations.common.aspect.AdminOnlyAspect.AdminOnly;
...
public class ConfigController {
    ...
    public RESTResult<PageResultVO<ConfigVO>> list(@io.swagger.v3.oas.annotations.parameters.RequestBody(
    ...
    public RESTResult<ConfigVO> get(
    ...
    public RESTResult<Void> delete(@io.swagger.v3.oas.annotations.parameters.RequestBody(
